...
class IOBoatsComponent extends Component {
    render() {
        ...
        const setting3 = setting(this.props.boatScheduleData._IOBoats.inSumPrev2, this.props.boatScheduleData._IOBoats.inSum2);
        const setting4 = setting(this.props.boatScheduleData._IOBoats.outSumPrev2, this.props.boatScheduleData._IOBoats.outSum2);
