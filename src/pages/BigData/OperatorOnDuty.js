	...
	render() {
		return (
		    <div className="zhiban">
	    		...
	    		<p><span>游船调度负责人：</span><span id="boat-head" contentEditable suppressContentEditableWarning onInput={this.saveHeadToLocalStorage('boat-head')}>{localStorage.getItem("boat-head") || "张俊峰"}</span></p>
